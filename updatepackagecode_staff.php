...
<div class = "table1">
	...
	echo "<td align = 'center'> <a class='archive' href= 'archivepackage_staff.php?id=$id'> Archive </a> </td>";
	echo "<td align = 'center'> $deliverystatus </td>";
	echo "<td align = 'center'> <a class='delivered' href= 'deliveredpackage_staff.php?id=$id&trackid=$trackid&consignorno=$consignorno&consignee=$consignee'> Delivered </a> </td></tr>";
