...
<div class = "table1">
	...
	echo "<td align = 'center'> <a class='archive' href= 'archivemoneyremit_staff.php?id=$id'> Archive </a> </td>";	
	echo "<td align = 'center'> <a class='unarchive' href= 'unarchivemoneyremit_staff.php?id=$id'> Unarchive </a> </td>";
	echo "<td align = 'center'> $remitstatus </td>";
	echo "<td align = 'center'> <a class='delivered' href= 'deliveredmoneyremit_staff.php?id=$id&consignorno=$consignorno&consignee=$consignee'> Delivered </a> </td></tr>";
