...
$remID=$_SESSION['recptsession'];
$result = mysql_query("select avg(M.FEE) + avg(P.declaredvalue),avg(M.FEE) + avg(P.declaredvalue)*7,avg(M.FEE) + avg(P.declaredvalue)*30,avg(M.FEE) + avg(P.declaredvalue)*90,avg(M.FEE) + avg(P.declaredvalue)*365 from tblmoney_remit M inner join tblpackage_delivery P 
